...
public class UGRectRingPipeline extends OpenCvPipeline {
    ...
    public double topRectWidthPercentage = 0.25;
    public double topRectHeightPercentage = 0.25;
    public double bottomRectWidthPercentage = 0.25;
    public double bottomRectHeightPercentage = 0.35;
    ...
    public UGRectRingPipeline(Telemetry telemetry) {
    ...
    public Mat processFrame(Mat input) {
        ...
        if (Math.abs(getTopAverage() - getBottomAverage()) < getThreshold() && (getTopAverage() <= 100 && getBottomAverage() <= 100)) {
            telemetry.addData("Stack Height", "FOUR");
        } else if (Math.abs(getTopAverage() - getBottomAverage()) < getThreshold() && (getTopAverage() >= 100 && getBottomAverage() >= 100)) {
            telemetry.addData("Stack Height", "ZERO");
        } else {
            telemetry.addData("Stack Height", "ONE");
        }
